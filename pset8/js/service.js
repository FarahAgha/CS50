...
/**
 * load houses to teleport shuttle 
 */
function teleporttohouse()
{   
    var html = "Teleport to:<select id = 'teleportid'> <option>Select</option>";
    for(house in HOUSES)
    {
...
// ********************************   Teleport shuttle to house name *********************************
function teleportto(housename)
{
    // TODO house position
    for(house in HOUSES)
    {
        ...
        {
            // house cordinates
            hlat = HOUSES[house].lat;
            hlng = HOUSES[house].lng;
            
            // shuttle's NEW Cartesian coordinates
            shuttle.localAnchorCartesian = V3.latLonAltToCartesian([hlat, hlng, 0]);
...
$(window).load(function() {
    ...
    // listen for click on teleport
    $("#teleportid").change(function(){
        teleportto($("#teleportid").val());
        //console.log($("#teleportid").val());
    });
});
